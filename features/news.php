                    ...
                    <div class="col-lg-8">
                        <div class="row">                            
                            <div class="col-md-6 mb-4">
                                <div class="card" onclick="window.location.href = 'news/b1.php';">
                                    <img src="../assets/img/1.jpg" class="card-img-top" alt="Image" id="b1" >
                                    <div class="card-body">
                                        <h5 class="card-title">Judul Berita</h5>
                                        <p class="card-text">Deskripsi singkat mengenai berita.</p>
                                    </div>
                                </div>
                            </div>                            
                            <div class="col-md-6 mb-4">
                                <div class="card" onclick="window.location.href = 'news/b2.php';">
                                    <img src="../assets/img/2.jpg" class="card-img-top" alt="Image" id="b1">
                                    <div class="card-body">
                                        <h5 class="card-title">Judul Berita</h5>
                                        <p class="card-text">Deskripsi singkat mengenai berita.</p>
                                    </div>
                        ...
                        <!-- Tambahkan card lainnya sesuai dengan jumlah berita -->
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Konten sidebar di sini.</p>
                            </div>
                        </div>
                    </div>
                </div>
